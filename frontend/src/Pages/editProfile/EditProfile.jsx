...
const EditProfile = () => {
  ...
  return (
    <div id="edit-profile">
        ...
        <p className="subtitle"> adicione uma image de perfil e conte mais sobre voce...</p>
        ...
        <form onSubmit={handleSubmit}>
            ...
            <input type="text" disabled onChange={(e) => setEmail(e.target.value)} value={email || ""} />
            <label>
